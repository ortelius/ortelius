    ...
    success : function(res)
    {
     ...
     for (var r = 0; r < res.data.length; r++)
     {
      ...
      else if (label == "LifeCycle Domain")
      {
       ...
       val = domain.value;
       tdedit += "<tr>";
       tdedit += "<td style=\"text-align:right;padding-right: 5px;white-space: nowrap;\">All Subdomains are Lifecycles:</td>";
       if (val)
       {
        ...
        || label == "Force Change Password")
      {
       if (label == "LifeCycle Domain")
        label = "All Subdomains are Lifecycles";
     ...
     if (objtype == "do")
     {
      $.ajax(
      {
       ...
       success : function(res)
       {
        ...
        {
         tdedit += "<tr>";
         tdedit += "<td style=\"text-align:right;vertical-align:top;padding-right: 5px;white-space: nowrap;\">Subdomains:</td>";
        ...
        for (var k = 0; k < res.length; k++)
        {
         ...
         if (k == 0)
          td += "<tr><td>Subdomains:</td><td>" + res[k].name + "</td></tr>";
         else
        ...
        if (res.length != 0)
        {
         ...
         tdedit += "<td></td>";
         tdedit += "</tr>";
         tdedit += "<tr id=\"dndmsg\"><td colspan=\"5\" style=\"padding-top:8px;\"><i>Drag and drop the Subdomains to order them for your lifecycle model.</i></td></tr>";
