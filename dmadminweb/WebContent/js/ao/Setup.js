...
function SetupWizard()
{
 ...
 tdedit3 += "one or more <I>Endpoints</I>. Environments can be found under the <I>Data Center</I> view.</LI>";
 tdedit3 += "<LI>An initial <I>Endpoint</I>. An Endpoint receives the deployment artifacts pulled from a ";
 tdedit3 += "<I>Repository</I>. The artifact(s) an Endpoint receives will depend on the <I>Component Types</I> ";
 tdedit3 += "it is set to accept. Endpoints can be found under the <I>Data Center</I> view.</LI>";
 ...
 tdedit3 += "Component has a <I>Endpoint Type</I> and this determines which <I>Endpoint</I> within the targeted ";
 ...
 tdedit3 += "First, let's decide in which <I>Domain</I> you want to create the initial objects. If you want to ";
 tdedit3 += "create a new domain then cancel this wizard, go to the <I>Domains</I> view, right click on the ";
 tdedit3 += "domain under which you want to create your new domain and select <I>New Sub-Domain</I>. Otherwise ";
 tdedit3 += "select the domain you want from the list below.";
 ...
 tdedit3 += "deployed by DeployHub to the <I>Endpoint(s)</I> within the target <I>Environment</I>.";
...
// Server
 ...
 tdedit3 += "<img src=\"css/images/dhlogo.png\"><BR><HR>";
 tdedit3 += "<B>Page 6 of 8 - Environment and Endpoint (part 1)</B><BR>";
 ...
 tdedit3 += "<table>";
 tdedit3 += "<tr>";
 tdedit3 += "<td style=\"text-align:right;padding-right: 5px;white-space: nowrap;\">Endpoint Type:</td>";
 tdedit3 += "<td style=\"padding-top:2px;padding-bottom:2px;\"><select name=\"servertype_val\">";
 tdedit3 += "<option value=\"st1\" selected>Unix</option>";
 tdedit3 += "<option value=\"st2\">Windows</option>";
 ...
 tdedit3 += "<option value=\"sftp\">ssh</option>";
 ...
 tdedit3 += "<LI>An initial <I>Environment</I>. An Environment represents a target for deployment and contains ";
 tdedit3 += "one or more <I>Endpoints</I>. Environments can be found under the <I>Data Center</I> view.</LI>";
 tdedit3 += "<LI>An initial <I>Endpoint</I>. This Endpoint will receives the build artifacts pulled from ";
 tdedit3 += "the Jenkins <I>Repository</I>.  Endpoints can be found under the <I>Data Center</I> view.</LI>";
 tdedit3 += "<LI>A <I>Build Engine</I> and <I>Build Job</I> to allow DeployHub to integrate with Jenkins. ";
 tdedit3 += "Build Engines can be found under the <I>Data Center</I> View.</LI>";
 tdedit3 += "<LI>An initial <I>Application</I>. An Application represents an object to be deployed to an ";
 tdedit3 += "<I>Environment</I>. An Application consists of one or more <I>Components</I>. Applications can be ";
 tdedit3 += "found under the <I>Deploy</I> View.</LI>";
 tdedit3 += "<LI>An initial <I>Component</I>. Components are deployed to <I>Endpoints.</I> This Component will ";
 tdedit3 += "be associated with the Build Job - this allows DeployHub to track which builds have been deployed to ";
 tdedit3 += "which Endpoint. Components can be found under the <I>Deploy</I> View.</LI>";
 tdedit3 += "<LI><I>Credentials</I> to allow access to the <I>Repository</I> and <I>End-Point</I>. Credentials ";
 tdedit3 += "can be found under the <I>Connections</I> View.</LI>";
 tdedit3 += "</UL>";
 tdedit3 += "The Wizard will create the relationships between all the objects automatically to allow you to start ";
...
// Edit Checks - shouldn't be necessary since we've checked on each page next click 
 ...
 tdedit3 += "<tr><td>Application:</td><td><img style=\"vertical-align:middle\" src=\"css/images/applications_sm.png\">&nbsp;<a href='javascript:SwitchDisplay(\"ap"+SetupAppId+"\");'>"+SetupAppName+"</td></tr>";
 tdedit3 += "<tr><td>Component:</td><td><img style=\"vertical-align:middle\" src=\"css/images/components_sm.png\">&nbsp;<a href='javascript:SwitchDisplay(\"co"+SetupCompId+"\");'>"+SetupCompName+"</td></tr>";
 tdedit3 += "<tr><td>Environment:</td><td><img style=\"vertical-align:middle\" src=\"css/images/environments_sm.png\">&nbsp;<a href='javascript:SwitchDisplay(\"en"+SetupEnvId+"\");'>"+SetupEnvName+"</td></tr>";
 tdedit3 += "<tr><td>Endpoint:</td><td><img style=\"vertical-align:middle\" src=\"images/server.png\">&nbsp;<a href='javascript:SwitchDisplay(\"se"+SetupServerId+"\");'>"+SetupServerName+"</td></tr>";
 ...
 if (SetupBuildEngineId!="") {
	 tdedit3 += "<tr><td>Build Engine:</td><td><img style=\"vertical-align:middle\" src=\"css/images/buildengines_sm.png\">&nbsp;<a href='javascript:SwitchDisplay(\"be"+SetupBuildEngineId+"\");'>"+SetupBuildEngineName+"</td></tr>";
	 tdedit3 += "<tr><td>Build Job:</td><td><img style=\"vertical-align:middle\" src=\"images/buildjobs_sm.png\">&nbsp;<a href='javascript:SwitchDisplay(\"bj"+SetupBuildJobId+"\");'>"+SetupBuildJobName+"</td></tr>";
 }
 tdedit3 += "</table>";
 if (wt==2) {
