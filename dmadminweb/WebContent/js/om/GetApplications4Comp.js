 ...
 $.getJSON(servlet, url, function(res)
  ...
  var rowcnt = 0;
   ...
   for (a = 0; a < data.length; a++)
   {
    ...
    td += "<tr class=\"clickablerow\" \"><td style=\"border: 1px solid #ddd;\"  id=\"" + row[0].type + row[0].id  +"\">" + linkval1 + "</td><td style=\"border: 1px solid #ddd;\" id=\"" + row[1].type + row[1].id  +"\">" + linkval2 + "</td></tr>";
    rowcnt++;
   }
