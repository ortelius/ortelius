...
CREATE TABLE dm_actionfilepath (
    ...
    filepath varchar2(2048) NOT NULL,
    copy character(1)
);
...
CREATE TABLE dm_credentials (
    id integer NOT NULL,
    kind integer,
    encusername varchar2(2048),
    encpassword varchar2(2048),
...
CREATE TABLE dm_deploymentscript (
    ...
    serverhostname varchar2(256),
    serverprotocol varchar2(64),
    cmd varchar2(2048),
    exitcode integer
);
...
CREATE TABLE dm_deploymentxfer (
    ...
    stepid integer NOT NULL,
    repoid integer,
    reponame varchar2(64),
    repoinstanceid integer,
    repopath varchar2(2048),
    repover varchar2(32),
    componentid integer,
    componentname varchar2(64),
    ...
    serverhostname varchar2(256),
    serverprotocol varchar2(64),
    checksum1 varchar2(256),
    checksum2 varchar2(256),
    created character(1),
...
CREATE TABLE dm_servertype (
    ...
    name varchar2(256),
    lineends integer,
    pathformat varchar2(256),
    scriptext varchar2(10)
);
...
INSERT INTO dm_fragmenttext VALUES (10, 'using component "@component@" {' || chr(10) ||
'  deploy;' || chr(10) ||
'}', 0);
...
INSERT INTO dm_fragmenttext VALUES (54, 'psloop {' || chr(10) ||
'  @0@' || chr(10) ||
'}', 0);
INSERT INTO dm_fragmenttext VALUES (55, 'echo "@message@";', 0);
INSERT INTO dm_fragmenttext VALUES (56, 'using stream $@stream_name@ {' || chr(10) ||
'  @0@' || chr(10) ||
'}' || chr(10)
, 0);
INSERT INTO dm_fragmenttext VALUES (57, 'parallel {' || chr(10) ||
'#if 1' || chr(10) ||
'  sequential {' || chr(10) ||
'    @1@' || chr(10) ||
'  }' || chr(10) ||
...
INSERT INTO dm_fragmenttext VALUES (60, 'if (@expression@) {' || chr(10) ||
'    @1@' || chr(10) ||
'}' || chr(10) ||
'#if 2' || chr(10) ||
'else {' || chr(10) ||
...
INSERT INTO dm_fragmenttext VALUES (210, 'avloop {' || chr(10) ||
'  @0@' || chr(10) ||
'}', 0);
INSERT INTO dm_fragmenttext VALUES (220, 'comploop {' || chr(10) ||
'  @0@' || chr(10) ||
'}', 0);
INSERT INTO dm_fragmenttext VALUES (230, 'using dropzone $@dropzone@ {' || chr(10) ||
'  @0@' || chr(10) ||
'}' || chr(10)
, 0);
INSERT INTO dm_fragmenttext VALUES (240, 'foreach(@varname@ : ${dropzone.find("@pattern@")}) {' || chr(10) ||
'  @0@' || chr(10) ||
'}', 0);
...
INSERT INTO dm_fragmenttext VALUES (270, 'modify(modifier: ''xml'', file: "@filename@", serverspecific: @server_specific@) {' || chr(10) ||
'  add_element(xpath: "@xpath@", pos: ''inside'',  value: "@newelement");}', 0);
INSERT INTO dm_fragmenttext VALUES (280, 'modify(modifier: ''text'', file: "@filename@", serverspecific: @server_specific@) {' || chr(10) ||
...
ALTER TABLE dm_applicationaccess
    ADD CONSTRAINT "appaccess-application-fk" FOREIGN KEY (appid) REFERENCES dm_application(id);
...
ALTER TABLE dm_applicationaccess
    ADD CONSTRAINT "appaccess-usergroup-fk" FOREIGN KEY (usrgrpid) REFERENCES dm_usergroup(id);
...
ALTER TABLE dm_applicationcomponent
    ADD CONSTRAINT "appcomp-application-fk" FOREIGN KEY (appid) REFERENCES dm_application(id);
...
ALTER TABLE dm_applicationcomponent
    ADD CONSTRAINT "appcomp-component-fk" FOREIGN KEY (compid) REFERENCES dm_component(id);
...
ALTER TABLE dm_applicationvars
    ADD CONSTRAINT "appvars-application-fk" FOREIGN KEY (appid) REFERENCES dm_application(id);
...
ALTER TABLE dm_environmentaccess
    ADD CONSTRAINT "envaccess-environment-fk" FOREIGN KEY (envid) REFERENCES dm_environment(id);
...
ALTER TABLE dm_environmentaccess
    ADD CONSTRAINT "envaccess-usergroup-fk" FOREIGN KEY (usrgrpid) REFERENCES dm_usergroup(id);
...
ALTER TABLE dm_environmentvars
    ADD CONSTRAINT "envvars-environment-fk" FOREIGN KEY (envid) REFERENCES dm_environment(id);
...
ALTER TABLE dm_providerdefprops
    ADD CONSTRAINT "provdefprops-provdef-fk" FOREIGN KEY (defid) REFERENCES dm_providerdef(id);
...
ALTER TABLE dm_repositorytextpattern
    ADD CONSTRAINT "reptextpatterns-repository-fk" FOREIGN KEY (repositoryid) REFERENCES dm_repository(id);
...
ALTER TABLE dm_repositoryvars
    ADD CONSTRAINT "repvars-repository-fk" FOREIGN KEY (repositoryid) REFERENCES dm_repository(id);
...
ALTER TABLE dm_repositoryignore
    ADD CONSTRAINT "repignore-providerdef-fk" FOREIGN KEY (defid) REFERENCES dm_providerdef(id);
