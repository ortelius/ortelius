insert into dm.dm_providerdef(id,name,kind,kindstr) values(17,'ldap',10,'datasource');
insert into dm.dm_propertydef(defid,name,required,appendable) values(17,'LDAP Server','Y','N');
