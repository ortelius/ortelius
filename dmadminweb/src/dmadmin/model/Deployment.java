...
public class Deployment extends DMObject
{
 /**
  * 
  */
 ...
 {
  return new LinkField(ObjectType.DEPLOYMENT, m_id, m_name, (m_finished != 0) ? m_session.formatDateToUserLocale(m_finished) : null);
 }
 ...
 public class DeploymentLogEntry implements Serializable
 {
  ...
  {
   return new JSONObject().add("lineno", m_lineno).add("stream", m_stream).add("line", getLineWithBreaks()).add("color", m_color);
  }
 }
 ...
 public class DeploymentXfer
 {
  ...
  public DeploymentXfer(int step, Repository repo, int repoInst, String repoPath, String repoVer, Component comp, Server target, String targetPath, String checksum, int buildno)
  {
   m_step = step;
   m_repo = repo;
   m_repoInst = repoInst;
 ...
 public class DeploymentScript
 {
  ...
  public DeploymentScript(int step, Action action)
  {
   m_step = step;
   m_action = action;
  }
