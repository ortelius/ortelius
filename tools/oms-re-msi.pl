...
my $re_wxs = 'E:/omci/OMS-RE/installers/ReleaseEngineer.wxs';
...
my @lib_dir_binaries = ('dmtransfer.exe', 'ftplib.dll', 'sftplib.dll', 'sshexec.exe', 'winexec.exe', 'winlib.dll');
...
my $winscp_cmd = "perl -S oms-winscp.pl ReleaseEngineer-build$job_number.msi /home5/openmake/public_html/qa";
