...
void bcopy(char *src,char *tgt,int len)
{
	for (int k=0;k<len;k++) tgt[k]=src[k];
}


void
xdrmem_create(XDR *xdrs, caddr_t addr, u_int size, xdr_op op)
{
 ...
 */
bool_t xdr_opaque(XDR *xdrs, caddr_t cp, long cnt)
{
