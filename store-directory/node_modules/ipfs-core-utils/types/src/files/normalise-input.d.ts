 ...
 */
export function normaliseInput(input: ImportCandidate | ImportCandidateStream): AsyncGenerator<import("ipfs-unixfs-importer/types/src/types").ImportCandidate, void, undefined>;
