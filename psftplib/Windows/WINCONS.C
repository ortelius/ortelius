                        ...
                        void (*callback)(void *ctx, int result), void *ctx)
{
	...
	//
	// TRINEM MOD - we need to invoke the callback function
	//
	...
	*/
	...
	//
	// No need to invoke callback function if key matches
	//
    ...
    if (ret == 2)
	{
		...
		fflush(stderr);
		*/
		CallbackResult = InvokeCallback(CALLBACK_KEY_DIFFERS,(void *)keytype,(void *)fingerprint);
    }
    if (ret == 1)
	{
		/* key was absent */
		...
		fflush(stderr);
		*/
		CallbackResult = InvokeCallback(CALLBACK_KEY_NEW,(void *)keytype,(void *)fingerprint);
    }
